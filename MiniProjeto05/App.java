...
//Escolhas dos Cap
cap1.esc.add(new Escolha("1", cap2,"sim"));
cap1.esc.add(new Escolha("2", cap3,"não"));

cap2.esc.add(new Escolha("1", cap4,"curar"));
cap2.esc.add(new Escolha("2", cap5,"lutar"));
cap2.esc.add(new Escolha("3", cap6,"buscar ajuda"));
